    ...
    return (
        <div>
            <div>
                ...
                <h3 className='text-2xl font-semibold mb-4 text-gray-900'>Confirm this ride to Start</h3>
                ...
                <div>
                    <div className='w-full mt-5'>
                        ...
                        }} className='w-full mt-3 text-white bg-red-600 font-bold p-2 rounded-lg'>Cancel</button>
